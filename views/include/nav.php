...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?=site_url('dashboard')?>"><img class="brand-logo" src="<?=site_url('assets/img/telkom2.gif')?>" alt="">TELKOM DU</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <?php if ($this->session->userdata['u_level'] == "Administrator")  { ?>
                    <li><a href="<?=site_url('major')?>">Jurusan</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if ($this->session->userdata['u_level'] == "Administrator")  { ?>
                            ...
                            <li><a href="<?=site_url('major/deleted')?>">Data Jurusan</a></li>
                        <?php } ?>
                    </ul>
                </li>
                <?php if ($this->session->userdata['u_level'] == "Administrator")  { ?>
